...
export const CampaignInfoCards = ({ campaign }: CampaignInfoCardsProps) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 lg:col-span-5">
      ...
      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 lg:col-span-2">
