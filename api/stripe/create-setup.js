...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('🔄 CREATE-SETUP: Création session checkout avec attachement immédiat');

    // Créer une session Checkout en mode setup avec attachement automatique
    ...
    console.log('✅ CREATE-SETUP: Session créée avec attachement automatique:', {
